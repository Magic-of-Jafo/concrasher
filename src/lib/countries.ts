// Shared country list for location pickers (convention editor + user home base).
// The convention's popular-magic-market countries are floated to the top; the
// rest follow alphabetically. Values stored on records are the `label` strings.
