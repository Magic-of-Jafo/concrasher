      ...
      if (incomingVenues) {
        ...
        for (const venueData of allVenuesFromRequest) {
          const venuePayload: any = {
            ...
            groupRateOrBookingCode: venueData.groupRateOrBookingCode,
            groupPrice: venueData.groupPrice,
            bookingLink: venueData.bookingLink,
            bookingCutoffDate: venueData.bookingCutoffDate,
