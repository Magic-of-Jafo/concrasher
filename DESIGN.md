...
Low-alpha tints of these hues (panels, hairlines, gradient fields) are tonal ramps of this system. Headers Montserrat, body Open Sans (interim, user-chosen). **Buttons are rectangles (4-8px radius), never pills** (see Do's and Don'ts). The old Electric Night violet was the runner-up, now retired.
